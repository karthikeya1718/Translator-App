...
import { B as Block, S as Static, e as BlockLabel, O as Code$2, g as Empty, i as IconButton, H as Copy$1, D as Download$1, h as IconButtonWrapper } from './2-D8EMzsJT.js';
...
const lang_map = {
  python: () => import('./index27-mCPGifM6.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-DG3Sgy40.js'),
      import('./frontmatter-CUHqytL-.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-B1xAay3h.js').then((m) => m.json()),
  html: () => import('./index29-BwlEl0kv.js').then((m) => m.html()),
  css: () => import('./index30-D6DwYkar.js').then((m) => m.css()),
  javascript: () => import('./index31-C9ciNm4p.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-C9ciNm4p.js').then(
...
//# sourceMappingURL=Index13-B9ehjWv6.js.map
